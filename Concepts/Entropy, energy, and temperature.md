...
- The density of configuration microstates depends just on the volume: $\Omega(x, y, z) \propto V$.
- Total number of microstates is the product of configuration and momentum microstates: $\Omega = \Omega(x, y, z) \times \Omega(p_x, p_y, p_z)$.
- Since entropy is defined in terms of the log, it is the sum of configuration and momentum entropies: $S=S(x, y, z) + S(p_x, p_y, p_z)$.